...
def main():
    ...
    file.write('![Status](https://github.com/dsp09/python-get-forecast/actions/workflows/build.yml/badge.svg)\n')
    file.write('![Status](https://github.com/dsp09/python-get-forecast/actions/workflows/pretty.yml/badge.svg)\n')
